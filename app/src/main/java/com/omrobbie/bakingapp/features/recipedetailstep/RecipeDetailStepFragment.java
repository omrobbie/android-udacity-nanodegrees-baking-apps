...
public class RecipeDetailStepFragment extends Fragment implements RecipeDetailStepView {
    ...
    @BindView(R.id.tv_unselected_step)
    TextView unselectedStepView;
    @BindView(R.id.view_detail_step)
    LinearLayout selectedStepView;
    @BindView(R.id.fab_next)
    FloatingActionButton nextButton;
    @BindView(R.id.fab_previous)
    FloatingActionButton previousButton;
    @BindView(R.id.tv_step_position)
    TextView stepPosition;
    @BindView(R.id.img_step)
    ImageView imageStep;
    @Nullable
    @BindView(R.id.view_bottom_nav)
